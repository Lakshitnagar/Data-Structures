...
int main(){
    ...
    int latitudes[NUM_OF_AIRPORTS] = {0, 30, 60};
    int longitudes[NUM_OF_AIRPORTS] = {25, -130, 78};

    // canTravel array gives the set of airports (space delimited) that airport 'i' allowed to fly to.
    string canTravel[NUM_OF_AIRPORTS] = {"1 2", "0 2", "1 2"};
    ...
    double minSrcToDest = dijkstra(airportsGraph, 0, 0);
